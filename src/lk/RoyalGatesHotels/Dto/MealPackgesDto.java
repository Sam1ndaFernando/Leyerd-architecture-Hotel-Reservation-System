...
public class MealPackgesDto implements SuperDto {
    ...
    public MealPackgesDto() {
    }

    public MealPackgesDto(String pkg_id, Double price, String description, String meal_plan, String type) {
        this.pkg_id = pkg_id;
        this.price = price;
