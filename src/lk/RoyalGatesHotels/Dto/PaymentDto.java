...
public class PaymentDto implements SuperDto {
    ...
    public PaymentDto(String paymentId, String hallReservationId, String time, String date, String orderId, String customerId, String roomReservationId, double amount) {
