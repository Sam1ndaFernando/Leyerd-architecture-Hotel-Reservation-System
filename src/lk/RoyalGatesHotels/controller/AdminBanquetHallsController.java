...
public class AdminBanquetHallsController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        hallsService = ServiceFactory.getInstance().getService(ServiceTypes.HALL_SERVICE);
        setAdminHall();
    ...
    private void setAdminHall() {
        try {
            String lastAdminHallId = hallsService.getLastAdminHallId();
    ...
    public void btnAddHall(ActionEvent actionEvent) throws IOException {
        ...
        if (isPriceMatched) {
            HallDto hall = new HallDto(
                ...
                boolean add = hallsService.add(hall);
